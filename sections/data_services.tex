...
These key image metadata are also stored in the Butler Registry (Butler section), however the ConsDB stores additional information  including derived metrics from image processing and information from the EFD transformed from the time dimension to the exposure dimension.
...
The detailed LSSTCam schema can be found at:
\url{https://sdm-schemas.lsst.io/cdb_lsstcam.html}