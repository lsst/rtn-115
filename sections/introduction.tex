...
\gls{DP2} is a reprocessing of all science-grade exposures acquired with \gls{LSSTCam}  during on-sky commissioning and the initial phase of early operations, prior to the formal start of the \gls{LSST}.
As such, it represents a natural boundary and provides a comprehensive dataset that captures the on-sky performance of the as-built system before \gls{LSST} starts.
