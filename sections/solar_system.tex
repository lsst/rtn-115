...
limited to objects whose observational arcs exceeded two days.\footnote{Small
bodies added to the MPC orbit database after this date---including objects
subsequently discovered in Rubin data---were absent from the association input
and therefore could not be associated with DP2 detections.}  Associations were
made independently for each detector and visit using positions predicted by
Sorcha \citep[][]{2025AJ....170..100M,2025AJ....170...97H} at the visit epoch
from this orbit catalog.
