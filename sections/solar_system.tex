...
Those discoveries were made in Prompt Processing and will be presented
separately.  DP2 does not deliver a catalog of Rubin discoveries; future data
releases will deliver such catalogs.
...
positions predicted by Sorcha \citep[][]{2025AJ....170..100M} at the visit epoch from the
orbit catalog used in DP2 processing.
...
test rather than a characterization of all objects.
...
variability, blending, or misassociation.
